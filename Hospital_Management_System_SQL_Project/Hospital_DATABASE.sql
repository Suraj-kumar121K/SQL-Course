...
INSERT INTO Physician(employee_id,name,position) 
VALUES
...
INSERT INTO Affiliated(Physician_id,department_id,primaryaffiliation) 
VALUES
(1,1,'t'),
(2,1,'t'),
(3,1,'f'),
...
CREATE TABLE Patient(
    ...
    FOREIGN KEY (primary_check) REFERENCES Physician(employee_id)
);

INSERT INTO Patient(name,surname,address,Gender,phone,primary_check)
VALUES
('John','Smith','42 Foobar Lane','Male','555-0256-896',2),
('Grace','Ritchie','37 Snafu Drive','Female','555-0512-657',2),
('Remo','Xavier','101 Omgbbq Street','Male','555-1204-345',9),
('Dennis','Doe','1100 Foobaz Avenue','Male','555-2048-345',17),
('John','Smith','123 Main St','Male','555-123-4567',24),
('Emily','Johnson','56 Elm St','Female','555-234-5678',7),
('Michael','Williams','789 Oak St','Male','555-345-6789',13),
('Sarah','Brown','101 Pine St','Female','555-456-7890',25),
('David','Jones','234 Maple St','Male','555-567-8901',28),
('Jessica','Davis','567 Cedar St','Female','555-678-9012',19),
('Christopher','Wilson','890 Birch St','Male','555-789-0123',5),
('Ashley','Taylor','111 Walnut St','Female','555-890-1234',33),
('Matthew','Martinez','222 Cherry St','Male','555-901-2345',3),
('Samantha','Anderson','333 Spruce St','Female','555-012-3456',18),
('Daniel','Garcia','444 Sycamore St','Male','555-123-4567',6),
('Amanda','Hernandez','555 Pineapple St','Female','555-234-5678',19),
('James','Lopez','666 Banana St','Male','555-345-6789',15),
('Jennifer','Gonzalez','777 Orange St','Female','555-456-7890',26),
('Joshua','Perez','888 Grape St','Male','555-567-8901',6),
('Brittany','Torres','999 Lemon St','Female','555-678-9012',20),
('Ryan','Flores','121 Apple St','Male','555-789-0123',28),
('Lauren','Ramirez','232 Pear St','Female','555-890-1234',6),
('Andrew','Cruz','343 Peach St','Male','555-901-2345',25),
('Nicole','Scott','454 Plum St','Female','555-012-3456',19),
('Justin','Morales','565 Watermelon St','Male','555-123-4567',24),
('Stephanie','Reed','676 Blueberry St','Female','555-234-5678',28),
('Brandon','Nguyen','787 Raspberry St','Male','555-345-6789',27),
('Megan','Hill','898 Kiwi St','Female','555-456-7890',6),
('Austin','Green','909 Pine St','Male','555-567-8901',33),
('Kayla','Adams','343 Cherry St','Female','555-678-9012',10),
('Tyler','Baker','454 Oak St','Male','555-789-0123',5),
('Haley','Campbell','565 Elm St','Female','555-890-1234',18),
('Dylan','Ward','676 Maple St','Male','555-901-2345',2),
('Victoria','Cox','787 Cedar St','Female','555-012-3456',13),
('Ethan','Rivera','898 Birch St','Male','555-123-4567',20),
('Hannah','Long','909 Walnut St','Female','555-234-5678',21),
('Noah','Diaz','343 Pine St','Male','555-345-6789',9),
('Olivia','King','454 Cherry St','Female','555-456-7890',30),
('Mason','Powell','565 Oak St','Male','555-567-8901',15);
